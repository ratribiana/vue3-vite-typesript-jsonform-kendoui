...
/**
 * Adds isFocused, appliedOptions and onChange
 */
export const useKendoControl = <
 ...
 */
export const useKendoLayout = <I extends { layout: any }>(input: I) => {
  const appliedOptions = computed(() =>
    merge(
      {},
 ...
 * Adds styles and appliedOptions
 */
export const useKendoLabel = <I extends { label: any }>(input: I) => {
  const appliedOptions = computed(() =>
    merge(
      {},
 ...
 */
export const useKendoArrayControl = <I extends { control: any }>(
  input: I
) => {
  const appliedOptions = computed(() =>
    merge(
